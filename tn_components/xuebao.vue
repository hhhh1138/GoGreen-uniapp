		...
		<view class="wrap">
			...
			<swiper class="swiper-box" :current="swiperCurrent" @transition="transition" @animationfinish="animationfinish">
					...
					<swiper-item class="swiper-item">
						<scroll-view scroll-y style="height: 100%;width: 100%;">
							<image src='@/static/animal_icon/xuebao.jpg' class="bg-set" mode="top left"></image>
							<!-- 图片展示 -->
							...
							<view class="grid col-2">
								...
								<view class="padding-xl"></view>								
								<view class="bg-img padding-bottom-xl" style="background-color: transparent;background-image: url('../static/xuebao/xuebao-1-1.jpg'); background-size:80% 80%;height: 250upx;"></view>
								<view class="bg-img padding-top-xl flex align-end" style="background-color: transparent;background-image: url('../static/xuebao/xuebao-1-2.jpg'); background-size:80% 80%;height: 250upx;"></view>
								<view class="padding-xl"></view>
								<view class="padding-xl"></view>								
								<view class="bg-img padding-bottom-xl" style="background-color: transparent;background-image: url('../static/xuebao/xuebao-1-3.jpg'); background-size:80% 80%;height: 250upx;"></view>
								<view class="bg-img padding-top-xl flex align-end" style="background-color: transparent;background-image: url('../static/xuebao/xuebao-1-4.jpg'); background-size:80% 80%;height: 250upx;"></view>
								<view class="padding-xl"></view>
								<view class="padding-xl"></view>								
								<view class="bg-img padding-bottom-xl" style="background-color: transparent;background-image: url('../static/xuebao/xuebao-1-5.jpg'); background-size:80% 80%;height: 250upx;"></view>
								<view class="bg-img padding-top-xl flex align-end" style="background-color: transparent;background-image: url('../static/xuebao/xuebao-1-6.jpg'); background-size:80% 80%;height: 250upx;"></view>
							</view>
						</scroll-view>
					...
					<swiper-item class="swiper-item">
						<scroll-view scroll-y style="height: 100%;width: 100%;">
							<image src='@/static/animal_icon/xuebao.jpg' class="bg-set" mode="top"></image>
							<!-- 物种属性 -->
							...
							<view class="grid col-1" style="margin-left: 15%;margin-top: 10%;">
								...
								<view class="text-df">__________________________</view>
								<view class="padding-xs text-df text-black">
									保护状况
								</view>
								<view class="padding-xs text-sl text-black">
									易危
								</view>
								<view class="text-df">__________________________</view>
								<view class="padding-xs text-df text-black">
					...
					<swiper-item class="swiper-item">
						<scroll-view scroll-y style="height: 100%;width: 100%;">
							<image src='@/static/animal_icon/xuebao.jpg' class="bg-set" mode="top right"></image>
							<!-- 生存危机 -->
							<view class="grid col-1" style="margin-left: 15%;margin-top: 10%;">
								<view class="padding-xs text-sl text-blue">
									威胁
								...
								<swiper-item class="swiper-item" style="width: 100%;height: 30%;">
									<view class="grid col-2 center" style="margin-right: 10%;">
										...
										<view class="flex align-end text-lg text-white center">
											气候变化已经造成雪豹的领地出现历史性干旱。雪豹可能丧失差不多31%的活动范围。
										</view>
									</view>
								</swiper-item>
							</swiper>
							...
							<swiper class="swiper-box" :current="swiperCurrent2" @transition="transition" @animationfinish="animationfinish2">
								...
								<swiper-item class="swiper-item" style="width: 100%;height: 30%;">
									<view class="grid col-2 center" style="margin-right: 10%;">
										...
										<view class="flex align-end text-lg text-white center">
											偷猎者捕猎雪豹不仅为了获得它们的皮毛，还为了获得在传统医药中可入药的骨头。
										</view>
									</view>
								</swiper-item>
							</swiper>
							...
							<swiper class="swiper-box" :current="swiperCurrent3" @transition="transition" @animationfinish="animationfinish3">
								...
								<swiper-item class="swiper-item" style="width: 100%;height: 30%;">
									<view class="grid col-2 center" style="margin-right: 10%;">
										...
										<view class="flex align-end text-lg text-white center">
											如果雪豹没有足够的野生猎物，它们将开始捕食家畜。而出于报复，雪豹常常被农民捕杀。
										</view>
									</view>
								</swiper-item>
							</swiper>
