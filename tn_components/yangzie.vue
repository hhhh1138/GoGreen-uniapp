		...
		<view class="wrap">
			...
			<swiper class="swiper-box" :current="swiperCurrent" @transition="transition" @animationfinish="animationfinish">
					...
					<swiper-item class="swiper-item">
						<scroll-view scroll-y style="height: 100%;width: 100%;">
							<image src='@/static/animal_icon/yangzie.jpg' class="bg-set" mode="top left"></image>
							<!-- 图片展示 -->
							...
							<view class="grid col-2">
								...
								<view class="padding-xl"></view>								
								<view class="bg-img padding-bottom-xl" style="background-color: transparent;background-image: url('../static/yangzie/yangzie-1-1.jpg'); background-size:80% 80%;height: 250upx;"></view>
								<view class="bg-img padding-top-xl flex align-end" style="background-color: transparent;background-image: url('../static/yangzie/yangzie-1-2.jpg'); background-size:80% 80%;height: 250upx;"></view>
								<view class="padding-xl"></view>
								<view class="padding-xl"></view>								
								<view class="bg-img padding-bottom-xl" style="background-color: transparent;background-image: url('../static/yangzie/yangzie-1-3.jpg'); background-size:80% 80%;height: 250upx;"></view>
								<view class="bg-img padding-top-xl flex align-end" style="background-color: transparent;background-image: url('../static/yangzie/yangzie-1-4.jpg'); background-size:80% 80%;height: 250upx;"></view>
								<view class="padding-xl"></view>
								<view class="padding-xl"></view>								
								<view class="bg-img padding-bottom-xl" style="background-color: transparent;background-image: url('../static/yangzie/yangzie-1-5.jpg'); background-size:80% 80%;height: 250upx;"></view>
								<view class="bg-img padding-top-xl flex align-end" style="background-color: transparent;background-image: url('../static/yangzie/yangzie-1-6.jpg'); background-size:80% 80%;height: 250upx;"></view>
							</view>
						</scroll-view>
					...
					<swiper-item class="swiper-item">
						<scroll-view scroll-y style="height: 100%;width: 100%;">
							<image src='@/static/animal_icon/yangzie.jpg' class="bg-set" mode="top"></image>
							<!-- 物种属性 -->
					...
					<swiper-item class="swiper-item">
						<scroll-view scroll-y style="height: 100%;width: 100%;">
							<image src='@/static/animal_icon/yangzie.jpg' class="bg-set" mode="top right"></image>
							<!-- 生存危机 -->
							<view class="grid col-1" style="margin-left: 15%;margin-top: 10%;">
								<view class="padding-xs text-sl text-blue">
									威胁
								...
								<swiper-item class="swiper-item" style="width: 100%;height: 30%;">
									<view class="grid col-2 center" style="margin-right: 10%;">
										...
										<view class="flex align-end text-lg text-white center">
											由于人口稠密且近百年来发展较快，长江中下游大面积湿地变成农田和城市，扬子鳄的栖息地被破坏，生存空间不断被压缩。
										</view>
									</view>
								</swiper-item>
							</swiper>
							...
							<swiper class="swiper-box" :current="swiperCurrent2" @transition="transition" @animationfinish="animationfinish2">
								...
								<swiper-item class="swiper-item" style="width: 100%;height: 30%;">
									<view class="grid col-2 center" style="margin-right: 10%;">
										...
										<view class="flex align-end text-lg text-white center">
											扬子鳄性情温和，在野生环境下基本不会捕食人和其他小动物，导致偷猎者很容易捕猎扬子鳄进行皮革或者肉类贸易。
										</view>
									</view>
								</swiper-item>
							</swiper>
							...
							<swiper class="swiper-box" :current="swiperCurrent3" @transition="transition" @animationfinish="animationfinish3">
								...
								<swiper-item class="swiper-item" style="width: 100%;height: 30%;">
									<view class="grid col-2 center" style="margin-right: 10%;">
										...
										<view class="flex align-end text-lg text-white center">
											人类活动导致扬子鳄产蛋地不断变迁和孵化率的下降，且农药的使用往往出现野生扬子鳄误食中毒猎物导致死亡的现象
										</view>
									</view>
								</swiper-item>
							</swiper>
